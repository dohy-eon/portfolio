          ...
          <div className="p-6 md:p-8 lg:p-10">
            ...
            <div className="mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                {project.stack.map((tech) => (
                  <span
                    key={tech}
                    className="px-3 py-1.5 bg-zinc-800/50 rounded-full text-xs md:text-sm text-zinc-300 border border-zinc-700 font-mono"
                  >
                    {tech}
                  </span>
                ))}
            ...
            {project.details && (
              <div className="space-y-8">
                ...
                {/* Features - 그리드 3열 */}
                <div>
                  <h3 className="text-white font-galmuri font-bold mb-4 text-lg md:text-xl border-b border-zinc-700 pb-2">
                    FEATURES
                  </h3>
                  <ul className="grid md:grid-cols-3 gap-4">
                    {project.details.features.map((feature, idx) => (
                      <li
                        key={idx}
                        className="text-xs md:text-sm text-gray-300 border border-zinc-800 p-3 bg-zinc-800/30"
                      >
                        {feature}
                      </li>
                    ))}
